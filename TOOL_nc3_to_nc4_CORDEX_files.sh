...
nccopy -k 4 -d 1    ${DIR23}/${VAR}/${VAR}_${text2}_mon_198901-199012.nc     ${DIR24}/${VAR}/${VAR}_${text2}_mon_198901-199012.nc
nccopy -k 4 -d 1    ${DIR23}/${VAR}/${VAR}_${text2}_mon_199101-200012.nc     ${DIR24}/${VAR}/${VAR}_${text2}_mon_199101-200012.nc
nccopy -k 4 -d 1    ${DIR23}/${VAR}/${VAR}_${text2}_mon_200101-200812.nc     ${DIR24}/${VAR}/${VAR}_${text2}_mon_200101-200812.nc
...
nccopy -k 4 -d 1    ${DIR33}/${VAR}/${VAR}_${text2}_sem_198903-199011.nc     ${DIR34}/${VAR}/${VAR}_${text2}_sem_198903-199011.nc
nccopy -k 4 -d 1    ${DIR33}/${VAR}/${VAR}_${text2}_sem_199012-200011.nc     ${DIR34}/${VAR}/${VAR}_${text2}_sem_199012-200011.nc
nccopy -k 4 -d 1    ${DIR33}/${VAR}/${VAR}_${text2}_sem_200012-200811.nc     ${DIR34}/${VAR}/${VAR}_${text2}_sem_200012-200811.nc
